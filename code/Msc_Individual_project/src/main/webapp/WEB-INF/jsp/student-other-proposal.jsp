  ...
  <div class="row content">
    <div class="col-sm-2 side">
				<ul class="nav nav-pills nav-stacked">
					<li class="active"><a href="/student/people">People</a></li>
					<li><a href="/student/others/plan/${OtherStudent.studentID}">View Plan</a></li>
					<li><a href="/student/others/proposal/${OtherStudent.studentID}">View Proposal</a></li>
				</ul>
    </div>
    <div class="col-sm-8 text-left"> 
	<c:if test="${Proposal.smApprove==1 and Proposal.spApprove==1}">
	      <h2>Proposal</h2>
...
<hr/>
	...
	<c:if test="${Proposal.smApprove!=1 and spApprove!=1}">
		Proposal Not approve yet
	</c:if>	
    </div>
